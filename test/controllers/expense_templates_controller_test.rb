...
class ExpenseTemplatesControllerTest < ActionController::TestCase
  ...
  test "should create expense_template" do
    ...
    post :create, expense_template: {section: expense_template.section, round: expense_template.round, way: expense_template.way, price: expense_template.price}, company_id: @company.id
  ...
  test "should fail to create expense_template" do
    post :create, expense_template: {section: @expense_template.section}, company_id: @company.id
    assert_template :new
    assert_equal I18n.t('cant_save'), flash[:alert]
  end

  test "should get edit" do
    get :edit, id: @expense_template.id, company_id: @company.id
    assert_response :success
  end

  test "should update expense_template" do
    post :update, id: @expense_template.id, expense_template: {section: @expense_template.section, round: @expense_template.round, way: @expense_template.way, price: @expense_template.price}, company_id: @company.id
    assert_redirected_to company_expense_templates_path(@company)
  ...
  test "should fail to update expense_template" do
    post :update, id: @expense_template.id, expense_template: {section: nil}, company_id: @company.id
    assert_template :new
    assert_equal I18n.t('cant_save'), flash[:alert]
  end

  test "should destroy expense_template" do
    delete :destroy, id: @expense_template, company_id: @company.id
    assert_redirected_to company_expense_templates_path(@company)
