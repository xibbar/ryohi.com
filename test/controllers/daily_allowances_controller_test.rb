...
class DailyAllowancesControllerTest < ActionController::TestCase
  ...
  test "should create daily_allowance" do
    post :create, daily_allowance: {name: @daily_allowance.name, one_day_allowance: @daily_allowance.one_day_allowance, accommodation_day_allowance: @daily_allowance.accommodation_day_allowance, return_day_allowance: @daily_allowance.return_day_allowance}, company_id: @company.id
  ...
  test "should fail to create daily_allowance" do
    post :create, daily_allowance: {name: nil}, company_id: @company.id
    assert_template :new
    assert_equal I18n.t('cant_save'), flash[:alert]
  end

  test "should get edit" do
    get :edit, id: @daily_allowance.id, company_id: @company.id
    assert_response :success
  end

  test "should update daily_allowance" do
    post :update, id: @daily_allowance.id, daily_allowance: {name: @daily_allowance.name, one_day_allowance: @daily_allowance.one_day_allowance, accommodation_day_allowance: @daily_allowance.accommodation_day_allowance, return_day_allowance: @daily_allowance.return_day_allowance}, company_id: @company.id
    assert_redirected_to company_daily_allowances_path(@company)
  ...
  test "should fail to update daily_allowance" do
    post :update, id: @daily_allowance.id, daily_allowance: {name: nil}, company_id: @company.id
    assert_template :new
    assert_equal I18n.t('cant_save'), flash[:alert]
  end

  test "should destroy daily_allowance" do
    delete :destroy, id: @daily_allowance.id, company_id: @company.id
    assert_redirected_to company_daily_allowances_path(@company)
