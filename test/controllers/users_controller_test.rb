...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should create user" do
    user = build(:user)
    get :create, user: {login: user.login, email: user.email, name: user.name, state: user.state, prefecture: user.prefecture, password: "password1234"}
    assert_redirected_to root_path
    assert_equal I18n.t('notice.create', model_name: User.model_name.human), flash[:notice]
  end

  test "must fail to create user" do
    get :create, user: {login: @user.login, email: nil, name: nil}
    assert_template :new
  ...
  test "should update user name" do
    login_user @user, signin_path
    patch :update, id: @user.id, user: {name: @user.name, current_password: "password1234"}
  ...
  test "must fail to update user name" do
    login_user @user, signin_path
    patch :update, id: @user.id, user: {name: "", current_password: "password1234"}
  ...
  test "should update user email" do
    login_user @user, signin_path
    patch :update_email, id: @user.id, user: {email: @user.email, current_password: "password1234"}
    assert_redirected_to users_path
    assert_equal I18n.t('notice.update', model_name: User.model_name.human), flash[:notice]
  end
  ...
  test "must fail to update user email" do
    login_user @user, signin_path
    patch :update_email, id: @user.id, user: {email: "", current_password: "password1234"}
  ...
  test "should get prefecture edit" do
    login_user @user, signin_path
    get :prefecture, id: @user.id
    assert_response :success
  end

  test "should update user prefecture" do
    login_user @user, signin_path
    patch :update_prefecture, id: @user.id, user: {prefecture: @user.prefecture, current_password: "password1234"}
    assert_redirected_to users_path
    assert_equal I18n.t('notice.update', model_name: User.model_name.human), flash[:notice]
  end
  ...
  test "must fail to update user prefecture" do
    login_user @user, signin_path
    patch :update_prefecture, id: @user.id, user: {prefecture: nil, current_password: "password1234"}
  ...
  test "should update user password" do
    login_user @user, signin_path
    patch :update_password, id: @user.id, user: {password: "password1234", password_confirmation: "password1234", current_password: "password1234"}
    assert_redirected_to users_path
    assert_equal I18n.t('notice.update', model_name: User.model_name.human), flash[:notice]
  end
  ...
  test "must fail to update user password" do
    login_user @user, signin_path
    patch :update_password, id: @user.id, user: {password: "password1234", password_confirmation: "pass1234", current_password: "password"}
  ...
  test "should activate user" do
    @user = create(:user)
    get :activation, activation_token: @user.activation_token
    assert_redirected_to users_path
  ...
  test "should not activate user" do
    @user = create(:user)
    get :activation, activation_token: "wrongtoken1234"
    assert_redirected_to root_path
